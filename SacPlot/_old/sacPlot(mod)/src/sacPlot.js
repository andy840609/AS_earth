function sacPlots() {
    ...
    chart.data = (vaule) => {
        ...
        xyPaths.forEach(path => {
            ...
            let startStr = 'data/';
            let startIndex = path.indexOf(startStr) + startStr.length;
            let endIndex = (path.search(/.sac/) >= 0) ? path.indexOf('.sac') : path.indexOf('.SAC');
    ...
    function chart() {
        ...
        function trace() {
            ...
            function getChartNodes(index, data, title) {
                ...
                // console.debug(origin_y_domain, pre_xdomain);
                // console.debug(y);
                var xAxis_g = g => g
                ...
                function events(svg) {
                    ...
                    let update_Axis = (x_domain, trans = false) => {
                        // console.debug('update', x_domain, origin_x_domain, x_domain.toString() == origin_x_domain.toString());
                    ...
                    // console.debug(pre_xdomain.length);
        ...
        function windowChart(data) {
            ...
            function events(svg, focus) {
                ...
                if (pre_xdomain) {
                    ...
                    update_yAxis(false, pre_xdomain);
                    renderChart(false);
                }
            }
        ...
        function printChart(plotType) {
            ...
            if (plotType == 'window') {
                ...
                chartGroup('wf_plot');
                var cloneArray = data.slice(0);
                $('#chart' + i).append(overlayChart(cloneArray.reverse()));
            }
            else {
                // console.debug(data);
