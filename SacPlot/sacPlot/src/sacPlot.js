function sacPlots() {
    ...
    function chart() {
        ...
        var floatCalculate = (method, ...theArgs) => {
            var result;
            function isFloat(n) {
        ...
        var toScientificNotation = (number, maxIndex = undefined) => {
                                    ...
                                    .attr("transform", function (d, i) {
                                        ...
                                        svg.select(".mouse-line")
                                            .attr("d", function () {
                                                ...
                                                var val = "M" + x(d.data[idx].x) + "," + (height - margin.bottom);
                                                val += " " + x(d.data[idx].x) + "," + margin.top;
