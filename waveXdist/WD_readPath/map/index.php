...
<body>
  ...
  <!-- <iframe id="iframe" name="framename" src="../example/waveXdist.html" frameborder="0" scrolling="no" width="100%" style="width: 100vw; height: 100vh;"></iframe> -->
...
<script>
  ...
  let selectCatalog = (catalog) => {

    window.open(`../example/waveform.php?catalog=${catalog}`,"_blank");
    // let waveform = document.getElementById('iframe').contentWindow.document;
    // let selector = waveform.querySelector("#form-chart #catalog");
    // let option = Array.from(selector.children).find(option => option.text === catalog);
