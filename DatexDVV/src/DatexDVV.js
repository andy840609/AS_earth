  ...
  function chart() {
    ...
    function DVVchart() {
          ...
          .call(() =>
            dotsGroup.selectAll(".dots").each(function (dki) {
              ...
              dots
                ...
                .attr("fill", "none")
                .attr("x", (d) =>
                  isNaN(d[dvvKey]) ? undefined : x(d[timeKey]) - width / 2
                )
                .attr("y", (d) =>
                  isNaN(d[dvvKey]) ? undefined : y(d[dvvKey]) - width / 2
                )
                ...
                .attr("stroke", function (d) {
                  ...
                  if (rd)
                    if (rd.indexOf(dki) != -1) {
                      if (!showRemove) this.style.opacity = 0;
                      return "grey";
                    }
                });
            })
      ...
      function updateChart(trans = false) {
        function init() {
          ...
          svg
            ...
            .attr(
              "display",
              d3.select("#showLegend").property("checked") ? "inline" : "none"
            )
            .call((g) =>
              g
                .append("rect")
                .attr(
                  "width",
                  shapeLegend_eachShape_width * dvv_dataKey_index.length
                )
            ...
            .attr(
              "transform",
              (d, i) => `translate(${i * shapeLegend_eachShape_width}, 0)`
            )
            .call((g_collection) =>
          ...
          overviewGroup
            .attr(
              "transform",
              `translate(${width - OV_width - 30}, ${
                margin.top * 0.3 + OV_toolbar_height
              })`
            )
            .attr(
              "display",
              d3.select("#showOverview").property("checked") ? "inline" : "none"
            )
            .call((overviewGroup) => {
              ...
              overviewGroup
                ...
                .call((tool_g) => {
                  let strokeWidth = 2;
                  let toolRect_dasharray = `${
                    OV_width + OV_toolbar_height * 0.6
                  }, ${OV_width}`;
                  tool_g
                    .append("rect")
                    .style("opacity", 0.8)
                  ...
                  tool_g
                    ...
                    .attr(
                      "transform",
                      `translate(${overviewRect_interval}, ${
                        OV_toolbar_height * 0.5
                      })`
                    )
                    .attr("fill", "currentcolor")
                    .attr("color", "black")
                  ...
                  let OT_buttonAction = (buttonIndex) => {
                    switch (
                      ...
                      case 0:
                        ...
                        let displayFlag = !displayAttr.indexOf(
                          overviewFocus.attr("display")
                        );
                        // console.debug(displayFlag)
                        overviewFocus.attr(
                          "display",
                          displayAttr[+displayFlag]
                        );
                        tool_g
                          .select("rect")
                          .attr(
                            "stroke-dasharray",
                            displayFlag ? toolRect_dasharray : null
                          );
                        overviewToolbarController
                          .selectAll("text")
                          .filter((d) => d === OT_buttonText[0])
                          .text(displayFlag ? "‒" : "□");
                        ...
                        if (displayFlag) {
                          ...
                          let matrix =
                            overviewGroup.node().transform.baseVal[0].matrix;
                          let translateX = matrix.e;
                          let translateY = matrix.f;
                          let yRangeMax =
                            height - (OV_toolbar_height + OV_height) + 5;

                          if (translateY > yRangeMax)
                            overviewGroup.attr(
                              "transform",
                              `translate(${translateX},${yRangeMax})`
                            );
                        }
                  ...
                  let overviewToolbarController = tool_g
                    .append("g")
                    ...
                    .join("g")
                    .call((buttons_g) =>
                      buttons_g.each(function (text, i) {
                        ...
                        bg.attr(
                          ...
                          `translate(${
                            OV_width -
                            (OT_buttonWidth + OT_buttonInterval) *
                              (OT_buttonAmount - i)
                          }, ${(OV_toolbar_height - OT_buttonWidth) * 0.5})`
                        );
              ...
              let overviewFocus = overviewGroup
                ...
                .call((overviewFocus) => {
                  ...
                  overviewFocus
                    ...
                    .attr(
                      "transform",
                      `translate(${overviewRect_interval * 0.5}, ${
                        overviewRect_interval * 0.5
                      })`
                    )
        ...
        function render() {
          ...
          var xAxisDomain = newDataObj.xSelected_domain
            ...
            : getNiceDomain(
                [newTimeArr[0], newTimeArr[newTimeArr.length - 1]],
                0.01
              );
          ...
          var yAxisDomain = newDataObj.ySelected_domain
            ...
            : getNiceDomain(
                d3.extent(
                  [].concat(
                    ...newData.map((d) =>
                      d3.extent(dvv_dataKey_index, (i) => d[dataKeys[i]])
                    )
                  )
                )
              );
          ...
          var updateFocus = () => {
            ...
            makeDots(focusGroup, newData, {
              x: x,
              y: y,
              width: dataRect_width,
              strokeWidth: dataRect_strokeWidth,
            });
          };
          var updateOverview = () => {
            ...
            if (overviewDots.node().childNodes.length == 0) {
              ...
              overview_x = d3.scaleUtc().domain(x.domain()).range([0, width]);
              overview_y = d3
                .scaleLinear()
                .domain(y.domain())
                .range([height, 0]);
              ...
              overviewGroup.selectAll(".dots").each(function (dki) {
                ...
                dots.selectAll("rect").attr("stroke", function (d) {
                  // console.debug(d)
                  ...
                  if (rd) {
                    if (rd.indexOf(dki) != -1) this.style.opacity = 0;
            ...
            removeData.forEach((rd, index) => {
              if (rd)
                rd.forEach((dki) => {
                  ...
                  let rectCollection = { 1: p1Group, 2: p2Group, 3: p3Group }[
                    group_count
                  ];
      ...
      function getNewData(xSelected_domain = null, ySelected_domain = null) {
        ...
        var get_newData = () => {
          let newData;
          if (!xSelected_domain) newData = data;
          else {
      ...
      function events(svg) {
        ...
        function chartEvent() {
          ...
          const mousePerLineCollection = mouseG
          ...
          //====================================for overview==================================================
          const overviewSelectionGroup = overviewGroup.select(
          ...
          var modeControl = (mode = "read") => {
            ...
            const dragBehavior = d3
              ...
              .on("end", () => {
                ...
                let selectionRect_width =
                  finalAttributes.x2 - finalAttributes.x1;
                let selectionRect_height =
                  finalAttributes.y2 - finalAttributes.y1;
                ...
                if (mode == "read") {
                  ...
                  let overview_xRange = xSelected_domain
                    ? [
                        overview_x(xSelected_domain[0]),
                        overview_x(xSelected_domain[1]),
                      ]
                    : [0, overview_x.range()[1]];
                  let overview_yRange = ySelected_domain
                    ? [
                        overview_y(ySelected_domain[0]),
                        overview_y(ySelected_domain[1]),
                      ]
                    : [overview_y.range()[0], 0];
                  overviewSelectionGroup.call(brushBehavior.move, [
                    [overview_xRange[0], overview_yRange[1]],
                    [overview_xRange[1], overview_yRange[0]],
                  ]);

                  selectionRect.remove();
                } else if (mode == "edit") {
                  if (xSelected_domain && ySelected_domain) {
                    //xSelected_domain 和 ySelected_domain !=null
                    let translateX =
                      finalAttributes.x1 +
                      (selectionRect_width - SC_width) * 0.5;
                    if (translateX + SC_width > width)
                      translateX = width - SC_width; //超出svg右邊界
            ...
            switch (mode) {
                ...
                event_rect
                  ...
                  .on("mousemove", function (event) {
                    ...
                    function getNew_dvvDataKeyIndex() {
                      ...
                      let inChart_dvv_dataKey_index = ySelected_domain
                        ? dvv_dataKey_index.filter((i) => {
                            ...
                            // console.debug(dvv);
                            if (
                              dvv >= ySelected_domain[0] &&
                              dvv <= ySelected_domain[1]
                            )
                              return i;
                          })
                        : [...dvv_dataKey_index]; //改變到原本dvv_dataKey_index圖表update顏色順序會錯
                      //2.undisplay的刪掉,removeData裡的也刪掉
                      inChart_dvv_dataKey_index =
                        inChart_dvv_dataKey_index.filter((i) => {
                          let isUndisplay =
                            undisplay_dataKeys_index.includes(i);
                          let isRemove = removeData[idx]
                            ? removeData[idx].includes(i)
                            : false;
                      ...
                      for (
                        let i = 0;
                        i < inChart_dvv_dataKey_index.length - 1;
                        i++
                      )
                        for (
                          let j = 0;
                          j < inChart_dvv_dataKey_index.length - 1 - i;
                          j++
                        )
                          // console.debug(data[idx][dataKeys[inChart_dvv_dataKey_index[sortedIndex[j]]]]);
                          if (
                            data[idx][dataKeys[inChart_dvv_dataKey_index[j]]] <
                            data[idx][
                              dataKeys[inChart_dvv_dataKey_index[j + 1]]
                            ]
                          ) {
                            let tmp = inChart_dvv_dataKey_index[j];
                            inChart_dvv_dataKey_index[j] =
                              inChart_dvv_dataKey_index[j + 1];
                    ...
                    function updateMouseLine() {
                      ...
                      mousePerLineCollection.attr("transform", function (d, i) {
                        // console.debug(d, i)
                        let translate = null;
                        let mousePerLine = d3.select(this);
                        let hasValue = !isNaN(data[idx][dataKeys[d]]);
                        let pointInChart =
                          inChart_dvv_dataKey_index.includes(d);
                        ...
                        if (hasValue && pointInChart) {
                          mousePerLine
                            .selectAll("circle")
                            .style("opacity", "1");
                          translate = `translate(${x(dataTimeArr[idx])}, ${y(
                            data[idx][dataKeys[d]]
                          )})`;
                        } else mousePerLine.selectAll("circle").style("opacity", "0");
                        return translate;
                      });
                    }
                    function updateTooltip() {
                      ...
                      tooltip
                        ...
                        .html(divHtml)
                        .selectAll()
                        .data(inChart_dvv_dataKey_index)
                        .enter()
                        .append("div")
                        .style("color", (d, i) =>
                          getColor(dvv_dataKey_index.indexOf(d))
                        )
                        .style("font-size", 10)
                        .html((d, i) => {
                          // console.debug(d, i);
              ...
              case "edit":
                ...
                event_rect.on("mouseleave", null).on("mousemove", null);
                break;
            }
          ...
          var chartOptionEvent = () => {
            ...
            //=====change display
            d3.selectAll('input[name ="display"]').on("change", (e) => {
              ...
              if (check) {
                display = "inline";
                undisplay_dataKeys_index = undisplay_dataKeys_index.filter(
                  (i) => i != dataKey_index
                );
              } else {
                display = "none";
            ...
            //=====editMode
            d3.select("#editMode").on("change", (e) => {
              let check = e.target.checked;
              modeControl(check ? "edit" : "read");
            });
            //=====shows
            d3.select("#showRemove").on("change", (e) => {
              let check = e.target.checked;
              showRemove = check;
              updateChart();
            });
          ...
          var selectionButtonEvent = () => {
              ...
              switch (
                ...
                case 1:
                  ...
                  if (buttonGroup.attr("act") == text) {
                    ...
                    let i1 = d3.bisectCenter(dataTimeArr, xSelected_domain[0]);
                    let i2 =
                      d3.bisectCenter(dataTimeArr, xSelected_domain[1]) + 1; //包含最大範圍
                    let tmpData = data.slice(i1, i2);
                    tmpData.forEach((d) =>
                      dvv_dataKey_index.forEach((dki) => {
                        let in_xSelected =
                          d[dataKeys[0]] >= xSelected_domain[0] &&
                          d[dataKeys[0]] <= xSelected_domain[1];
                        let in_ySelected =
                          d[dataKeys[dki]] >= ySelected_domain[0] &&
                          d[dataKeys[dki]] <= ySelected_domain[1];
                        if (in_xSelected && in_ySelected) {
                          ...
                          if (!removeData[index])
                            //==undefine or null
                            removeData[index] = [];
                          if (removeData[index].indexOf(dki) == -1)
                            //==不放入重複元素
              ...
              g.selectAll(".buttonGroup")
                ...
                .call((buttonGroupCollection) =>
                  buttonGroupCollection.each(function (i) {
                    ...
                    let bg = d3.select(this);
                    let translateX =
                      (outerWidth / buttonAmount) * i +
                      (outerWidth / buttonAmount - buttonWidth) * 0.5;
                    ...
                    bg.attr("cursor", "pointer")
                      .on("click", function (e) {
                        ...
                        if (g.attr("display") != "inline") return;
            ...
            const EZA_width = width * 0.8,
              EZA_height = height * 0.7;
            editZoomArea.attr("display", "none").call((editZoomArea) => {
              //外框
              editZoomArea
                .append("rect")
                .attr("id", "EZA_outer")
              ...
              editZoomArea
                ...
                .attr(
                  "transform",
                  `translate(${(width - EZA_width) * 0.5}, ${
                    (height - EZA_height) * 0.5
                  })`
                )
                .attr("id", "EZA_inner")
                .attr("width", EZA_width)
              ...
              editZoomAreaController
                ...
                .attr(
                  "transform",
                  `translate(${(width - EZA_buttonGroup_width) * 0.5}, ${
                    (height + EZA_height) * 0.5 + 10
                  })`
                )
          ...
          var overviewEvent = () => {
            ...
            brushBehavior = d3
              ...
              .on("start", (e) => {
                ...
                d3.select(".selectionGroup").call((selectionGroup) => {
              ...
              .on("brush end", (e) => {
                ...
                if (!brushFlag) pre_updateTimeout.stop();

                pre_updateTimeout = d3.timeout(() => {
                  // brushFlag = true
                  xSelected_domain = [
                    overview_x.invert(selection[0][0]),
                    overview_x.invert(selection[1][0]),
                  ];
                  ySelected_domain = [
                    overview_y.invert(selection[1][1]),
                    overview_y.invert(selection[0][1]),
                  ];
                  // console.debug(xSelected_domain, ySelected_domain);
                  newDataObj = getNewData(xSelected_domain, ySelected_domain);
                  // console.debug(newDataObj);
