...
var assetsDir = 'data/assets/';
var datafileDir = 'data/datafile/'; // const defaultControllCursor = {
//     up: 'UP',
//     down: 'DOWN',
//     left: 'LEFT',
//     right: 'RIGHT',
...
var GameObjectStats = {
  ...
  player: {
    ...
    maleAdventurer: {
      ...
      bulletSize: [120, 130],
      knockBackSpeed: 250,
      //==擊退時間固定200ms,這個速度越大擊退越遠
      manaCost: 10,
      manaRegen: 0.1,
      //per 10 ms(game update per 10ms)0.1
      HP: 150,
      maxHP: 150,
      MP: 60,
      maxMP: 60,
